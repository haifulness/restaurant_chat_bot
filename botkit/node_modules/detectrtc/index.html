...
<html lang="en">
    <head>
        <title>DetectRTC | Is WebRTC Supported On Your Browser?</title>
        ...
        <article>
            ...
            <script>
                ...
                function onDetectRTCLoaded() {
                    ...
                    appendTR('Website has mcirophone permissions?', printVal(DetectRTC.isWebsiteHasMicrophonePermissions), 'isWebsiteHasMicrophonePermissions');
                    ...
                    appendTR('Browser Supports WebSockets?', printVal(DetectRTC.isWebSocketsSupported), 'isWebSocketsSupported');
